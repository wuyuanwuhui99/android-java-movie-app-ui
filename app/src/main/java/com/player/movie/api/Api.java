...
public class Api {
    public static final String HOST = "http://192.168.137.1:5001";
    //查询所有大分类
    public static final String GETUSERDATA = "/service/user/getUserData";
    ...
    public static final String LOGIN =  "/service/user/login"; //登录
    public static final String GETSTAR =  "/service/movie/getStar/{movieId}"; //获取演员
    ...
    public static final String UPDATEUSER = "/service/user-getway/updateUser";//更新用户信息
    public static final String UPDATEPASSWORD = "/service/user-getway/updatePassword";//更新密码
    public static final String GETCOMMENTCOUNT = "/service/social/getCommentCount";//获取评论总数
