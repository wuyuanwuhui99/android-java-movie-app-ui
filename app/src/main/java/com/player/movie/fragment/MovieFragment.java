...
public class MovieFragment extends Fragment {
    ...
    private void addSearchFraction(){
        ...
        transaction.replace(R.id.movie_search_layout,new SearchFragment(BaseApplication.getInstance().getResources().getString(R.string.tv)))
                .commit();
    }
    ...
    public void getAllCategoryListByPageName(){
        Call<ResultEntity> categoryListService = RequestUtils.getMovieInstance().getAllCategoryListByPageName("电影");
        categoryListService.enqueue(new Callback<ResultEntity>() {
            @Override
            public void onResponse(Call<ResultEntity> call, Response<ResultEntity> response) {
